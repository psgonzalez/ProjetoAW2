...
@if ($errors->any())
    ...
    <div class="alert alert-danger">
        ...
        <strong>Whoops!</strong> Existem alguns erros durante o cadastro.<br><br>
...
<form action="{{ route('monkeys.store') }}" method="POST">
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <div class="form-group">
                ...
                <input type="text" name="especie" class="form-control" placeholder="Espécie">
